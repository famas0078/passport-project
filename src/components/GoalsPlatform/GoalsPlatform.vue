...
<div class="wrapper-goalsPlatform">
  <div class="container">
    ...
    <div class="row">
      <div class="col-xl-6">
        <div class="card-item one-card-item">
          <img class="img-mobile" src="../../assets/img/OneIcon.svg" alt="" height="50px" width="50px" />
          <div class="title">
      ...
      <div class="col-xl-6 d-flex justify-content-between">
            <img class="img-desktop" src="../../assets/img/OneIcon.svg" alt="" height="50px" width="50px" />
            <div></div>
      </div>
    </div>
    <div class="row mt-5">
      ...
      <div class="col-xl-6 d-flex justify-content-between align-items-md-start">
        <img class="img-desktop" src="../../assets/img/TwoIcon.svg" alt="">
        <div class="card-item two-card-item">
          <img class="img-mobile" src="../../assets/img/TwoIcon.svg" alt="">
          <div class="title">
    ...
    <div class="row mt-5">
      <div class="col-xl-6">
        <div class="card-item one-card-item">
          <img class="img-mobile" src="../../assets/img/ThreeIcon.svg" alt="">
          <div class="title">
      ...
      <div class="col-xl-6">
        <div class=" d-flex justify-content-between">
          <img class="img-desktop" src="../../assets/img/ThreeIcon.svg" alt="">
          <div></div>
        </div>
      </div>
    </div>
