<template>
    <div class="wrapper-how-we-selected justify-content-between container mt-5">
        <img src="../../../assets/img/lendingPages/otbor.svg" class="mobile_img" alt="" width="280px" height="202px">
        ...
        <img src="../../../assets/img/lendingPages/otbor.svg" class="dekstop_img" alt="">
    </div>
</template>