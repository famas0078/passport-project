          ...
          <div class="accordion-item" v-for="item in accordions" :key="item.id"
            ...
            <div class="accordions-title d-flex justify-content-between">
              ...
              <div class="accordions-arrow">
                <img v-if="ActiveAccordion != item.id" src="../../../assets/img/lendingPages/arrowAccordionNotActive.svg"
                  alt="">
                <img v-if="ActiveAccordion === item.id" src="../../../assets/img/lendingPages/arrowAccordionActive.svg" alt="">
              </div>
            </div>
