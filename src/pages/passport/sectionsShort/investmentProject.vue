  ...
  <div class="wrapper-simple-form-item px-3">
    <div>
      <div class="title uppercase">
        Инвестиционный проект (реальный сектор экономики)
      </div>
      <div class="description mt-4">
        <div class="card-w wrapper-types">
          ...
          <div>
            ...
            <ul>
              <li>
                <input class="form-input-item-input" type="text" placeholder="Сумма инвестиций" v-model="form.amountOfInvestment" >
              </li>
            </ul>
          </div>
