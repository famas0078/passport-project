  ...
  <div class="wrapper-simple-form-item px-3">
    <div>
      <div class="title uppercase">
        Изобретение, технология, ноу-хау
      </div>
      <div class="description mt-4">
        <div class="card-w wrapper-types">
          ...
          <div>
            <div class="types-title text-left">
              Краткая суть изобретения, технологии, ноу-хау
            </div>
            <ul>
              <li>
          ...
          <div>
            ...
            <ul>
              <li>
                <input class="form-input-item-input" type="text" placeholder="Сумма" v-model="form.intellectualProperty" >
              </li>
            </ul>
          </div>
          <div>
