  ...
  <div class="px-3">
    ...
    <div class="index-btn d-flex">
      <div class="btn-last btn-item" @click="lastSlider()">
        <img src="../../assets/img/passportPages/Vector.svg" alt="">
        К прошлому разделу
      </div>
...
import FiveSection from "@/pages/passport/Section/FiveSection.vue";
import SixSection from "@/pages/passport/Section/SixSection.vue";
