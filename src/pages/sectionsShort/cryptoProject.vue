  ...
  <div class="wrapper-simple-form-item px-3">
    <div>
        ...
        <div class="card-w wrapper-types">
          ...
          <div class="form-input-item">
            <label class="form-input-item-label text-left">
              На какой стадии реализации находится проект?
            </label>
            <div >
              <ul>
          ...
          <div class="mt-3">
            ...
            <ul>
              <li>
                <input class="form-input-item-input" type="text" placeholder="telegram" v-model="form.telegram" >
              </li>
            </ul>
          </div>
      ...
      <div class="alert" :class="{ 'show': success, 'error': error }">
        {{ success ? 'Успешно отправлено!' : error_text }}
      </div>
    </div>
  </div>
</template>
