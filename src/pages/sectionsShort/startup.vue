      ...
      <div class="description mt-4">
        <div class="card-w wrapper-types">
          <div>
            ...
            <ul>
              <li>
                <input class="form-input-item-input" type="text" placeholder="Название проекта" v-model="form.name" >
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul>
              <li>
                <input class="form-input-item-input" type="text" placeholder="Город проекта" v-model="form.cityOfTheProject" >
              </li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <ul>
              <li>
                <input class="form-input-item-input" type="text" placeholder="Рынок" v-model="form.market" >
              </li>
            </ul>
          </div>
            ...
            <div >
              <ul>
                <li v-for="(item, index) in status" :key="index">
                  <input :id="'needs' + index" type="radio" name="needs" :value="item.id" v-model="form.projectStageId">
          ...
          <div>
            ...
            <ul>
              <li>
                <input class="form-input-item-input" type="text" placeholder="Решение" v-model="form.solvedProblem" >
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul>
              <li>
                <input class="form-input-item-input" type="text" placeholder="Преимущество" v-model="form.advantageOfProjects" >
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul>
              <li>
                <input class="form-input-item-input" type="text" placeholder="Бизнес-модель" v-model="form.businessModel" >
              </li>
            </ul>
          </div>
          <div>
          ...
          <div class="form-input-item file w-100">
            <label class="form-input-item-label text-left">
              Прикрепить презентацию (резюме) проекта
          ...
          <div class="form-input-item file mb-3 w-100">
            <label class="form-input-item-label text-left">
              Прикрепить финансовую модель (бизнес-план, ТЭО) проекта

            </label>
            <span class="comment">
              Формат: pdf
            </span>
            <label class="input-file d-flex justify-content-between w-100 cursor-pointer" for="input-file-fin">
              <p class="input-file-text">
                {{ fileFinancialModel ? fileFinancialModel : 'Финансовая модель'}}
              </p>
              <img class="input-file-image" src="@/assets/img/peperClip.svg">
            </label>
            <input class="form-input-item-input-files h-100" id='input-file-fin' type="file" @change="handleFileFinancialModelChange">
            <p class="text-danger">
          ...
          <div>
            ...
            <ul>
              <li>
                <input class="form-input-item-input" type="text" placeholder="Ссылка" v-model="form.site" >
              </li>
            </ul>
          </div>
          <div>
